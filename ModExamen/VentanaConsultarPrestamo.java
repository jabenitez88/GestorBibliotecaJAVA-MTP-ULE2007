...
public class VentanaConsultarPrestamo extends JInternalFrame
{
	...
	class ConsultorioPrestamo extends JPanel implements ActionListener
	{
		...
		JRadioButton botonFueraPlazo   	= new JRadioButton("Fuera de plazo"  , false);
		...
		{	
			...
			bgroupLoR.add(botonFueraPlazo);
			botonFueraPlazo.addActionListener(this);
			botonFueraPlazo.setActionCommand("FUERA");
			...
			radioPanel.add(botonFueraPlazo);
	    ...
	    public void actionPerformed(ActionEvent e) 
	    {
			...
			if (BUSCAR.equals(e.getActionCommand()))
			{
			   ...
			   {
				   tblResultados.setModel(buscador.ConsultaPrestamo2());
			   }
			...
			{	
				...
				if(!consulta) // Si no es consulta....
				{
					...
					{
						if(fechaActual == 1) // Si es verdad fechaActual.... te deja ampliar
						{
			...
			else if ("FUERA".equals(e.getActionCommand()))
			{
				FueraPlazo = true;
				textBusqueda.setEnabled(false);
			}
